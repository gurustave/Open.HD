...
do
        ...
        isRestart=0
        stdbuf -oL gst-launch-1.0 alsasrc device=plughw:1,0 name=mic provide-clock=true  do-timestamp=true buffer-time=20000 ! alawenc ! rtppcmapay max-ptime=20000000 ! udpsink host=127.0.0.1 port=5050 |
